...
[] Any user can create an account - Valid inputs include: A valid email address & Password - Verification process - Confirmation of typed password to validate password
